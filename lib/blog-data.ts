...
const posts: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'These combine a discount offer with a time-limited urgency element. A countdown timer creates a sense of scarcity that motivates immediate action. However, use these sparingly — overuse can feel manipulative and erode trust.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'First-time visitors to your store may hesitate at checkout if they don\'t see familiar trust indicators — security badges, return policies, customer reviews, and clear contact information all play a role in checkout confidence.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'list', items: [
        ...
        '<strong>24 hours later:</strong> A follow-up that adds social proof — customer reviews, ratings, or testimonials related to the products in their cart.',
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'When visitors encounter these patterns, they develop "popup blindness" — they reflexively close popups without reading them. Your future popups, even well-designed ones, get caught in this pattern.' },
      ...
      { type: 'paragraph', text: 'The best popups respond to what the visitor is doing. An exit intent popup on a cart page is contextually relevant — the visitor has items they\'re considering, and you\'re offering to sweeten the deal. A generic email capture popup on a blog post is a non-sequitur interruption.' },
