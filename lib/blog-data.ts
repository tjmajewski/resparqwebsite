...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'list', items: [
        '<strong>~70% average abandonment rate</strong> across ecommerce, aggregated over many documented studies.',
        '<strong>Mobile runs higher, often 75-85%,</strong> where smaller screens, fiddly form fields, and interruptions all add friction.',
        '<strong>Desktop tends to be lower, in the 65-73% range,</strong> where checkout is easier and sessions are less likely to be interrupted.',
        '<strong>Some categories exceed 80%,</strong> particularly high-consideration purchases like travel, finance, and big-ticket goods where shoppers research heavily before committing.'
      ] },
      ...
      { type: 'paragraph', text: 'Understanding the why is what makes the statistics actionable. Surveys of abandoning shoppers consistently surface the same reasons, and most of them are fixable.' },
      { type: 'heading3', text: 'Unexpected Extra Costs', id: 'unexpected-costs' },
      { type: 'paragraph', text: 'The most cited reason, named by roughly half of abandoning shoppers, is extra costs appearing at checkout: shipping, taxes, and fees. When the total jumps between the product page and the payment step, trust erodes and the shopper leaves. This is why <strong>free shipping offers</strong> are so effective at recovery, they directly neutralize the top objection.' },
      { type: 'heading3', text: 'Being Forced to Create an Account', id: 'forced-account-creation' },
      { type: 'paragraph', text: 'Around a quarter of shoppers abandon when a store requires account creation before checkout. Guest checkout is one of the highest-leverage, lowest-effort fixes available to any Shopify store.' },
      { type: 'heading3', text: 'A Long or Complicated Checkout', id: 'long-checkout' },
      { type: 'paragraph', text: 'Every additional field and step sheds conversions. Shoppers abandon checkouts that feel long, ask for information they consider unnecessary, or fail to show progress. Reducing steps and pre-filling known data recovers a meaningful share of these.' },
      { type: 'heading3', text: 'Just Browsing and Comparison Shopping', id: 'just-browsing' },
      { type: 'paragraph', text: 'A large slice of abandonment is not a checkout failure at all, these shoppers were never ready to buy on this visit. They are comparing options, saving carts as wishlists, or waiting for a reason to act. This is exactly the segment where a well-timed <strong>exit intent</strong> intervention changes the outcome, giving a hesitating shopper the nudge they need before they leave to compare elsewhere.' },
      { type: 'heading3', text: 'Payment and Trust Concerns', id: 'payment-trust' },
      { type: 'paragraph', text: 'Shoppers abandon when they do not see their preferred payment method, when the site feels insecure, or when a first purchase from an unfamiliar brand carries too much perceived risk. Trust signals, reviews, and guarantees address this segment.' },
      ...
      { type: 'paragraph', text: 'The classic tactic. Abandoned cart email sequences typically recover a meaningful single-digit to low-double-digit percentage of carts, but only for shoppers whose email you already captured, which excludes most first-time visitors. Emails also arrive after the shopper has left, when purchase intent has cooled.' },
      ...
      { type: 'list', items: [
        '<strong>Mobile carries most of the traffic</strong> but a disproportionate share of the abandonment, often 75-85%.',
        '<strong>Desktop converts better per session,</strong> so a fixed-percentage view of your funnel hides where the real losses are.',
